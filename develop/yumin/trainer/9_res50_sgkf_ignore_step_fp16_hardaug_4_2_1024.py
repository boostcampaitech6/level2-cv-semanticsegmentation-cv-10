...
def save_model(model, file_name='_9_res50_sgkf_ignore_step_fp16_hardaug_4_2_1024.pt'):
...
def train(model, data_loader, val_loader, criterion, optimizer):
    ...
    best_dice = 0.
    scaler = GradScaler()
    wandb.init(entity='level2-cv-10-detection', project='yumin', name='9_res50_sgkf_ignore_step_fp16_hardaug_4_2_1024')
