...
def save_model(model, file_name='_4_base_res50_step_crop_BC_16_4.pt'):
...
def train(model, data_loader, val_loader, criterion, optimizer):
    ...
    best_dice = 0.
    scaler = GradScaler()
    wandb.init(entity='level2-cv-10-detection', project='yumin', name='4_base_res50_step_crop_BC_16_4')
