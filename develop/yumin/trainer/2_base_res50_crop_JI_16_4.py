...
def save_model(model, file_name='_2_base_res50_crop_JI_16_4.pt'):
...
def train(model, data_loader, val_loader, criterion, optimizer):
    ...
    n_class = len(CLASSES)
    best_dice = 0.
    wandb.init(entity='level2-cv-10-detection', project='yumin', name='2_base_res50_crop_JI_16_4')
...
checkpoint_path = './save_dir/_base_res50_crop_jjitter_16_4.pt'
