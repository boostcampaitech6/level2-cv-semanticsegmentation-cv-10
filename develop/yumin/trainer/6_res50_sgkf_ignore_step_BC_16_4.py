...
def save_model(model, file_name='_6_res50_sgkf_ignore_step_BC_16_4.pt'):
...
def train(model, data_loader, val_loader, criterion, optimizer):
    ...
    best_dice = 0.
    scaler = GradScaler()
    wandb.init(entity='level2-cv-10-detection', project='yumin', name='6_res50_sgkf_ignore_step_BC_16_4')
