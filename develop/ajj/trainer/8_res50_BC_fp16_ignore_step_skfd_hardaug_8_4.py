...
# 데이터 경로를 입력하세요
WAND_NAME = '8_res50_BC_fp16_ignore_step_skfd_hardaug_8_4'
SAVE_PT_NAME = '_8_res50_BC_fp16_ignore_step_skfd_hardaug_8_4.pt'
...
tf_1 = A.Compose([
                ...
                A.OneOf([A.OneOf([A.Blur(blur_limit = 4, always_apply = True),
                                    ...
                                    A.MedianBlur(blur_limit = 3, always_apply = True)], p=1), # ValueError: MedianBlur supports only odd blur limits. 4 -> 3으로 수정
